...
class Settings(BaseSettings):
    DATABASE_URL: str = os.getenv(
        "DATABASE_URL",
        "postgresql://bot_admin:qq_bot_secure_password_2024@localhost:5432/qq_bot"
    )
    ...
    BOT_QQ_NUMBER: str = os.getenv("BOT_QQ_NUMBER", "")
    NAPCAT_HTTP_URL: str = os.getenv("NAPCAT_HTTP_URL", "http://localhost:3001")
    NAPCAT_WS_URL: str = os.getenv("NAPCAT_WS_URL", "ws://localhost:3002")
